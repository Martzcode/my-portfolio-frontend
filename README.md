...
*   **Framework:** [Angular](https://angular.io/) (v16+ / latest stable release) - Utilizing its robust component model, dependency injection, and modern reactive features.
...
*   **Framework :** [Angular](https://angular.io/) - Exploitation des composants, de l'injection de dépendances et de la programmation réactive.
